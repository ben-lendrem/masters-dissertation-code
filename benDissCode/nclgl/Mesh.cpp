...
Mesh* Mesh::GenerateCube() {
	//FUNCTION SOURCE
	//taken from:
	//https://stackoverflow.com/questions/50401474/texture-coordinates-on-a-triangle-strip
	Mesh* m = new Mesh();
	m->type = GL_TRIANGLE_STRIP;
	m->numVertices = 12;
	m->numIndices = 18;
	...
	m->vertices[0] = Vector3(-10, 10, 10);
	m->vertices[1] = Vector3(10, 10, 10);
	m->vertices[2] = Vector3(-10, -10, 10);
	m->vertices[3] = Vector3(10, -10, 10);
	m->vertices[4] = Vector3(-10, -10, -10);
	m->vertices[5] = Vector3(10, -10, -10);
	m->vertices[6] = Vector3(-10, 10, -10);
	m->vertices[7] = Vector3(10, 10, -10);
	m->vertices[8] = Vector3(-10, 10, -10);
	m->vertices[9] = Vector3(-10, -10, -10);
	m->vertices[10] = Vector3(10, -10, -10);
	m->vertices[11] = Vector3(10, -10, 10);

	m->textureCoords[0] = Vector2(0, 0);
	m->textureCoords[1] = Vector2(1, 0);
	m->textureCoords[2] = Vector2(0, 1);
	m->textureCoords[3] = Vector2(1, 1);
	m->textureCoords[4] = Vector2(0, 0);
	m->textureCoords[5] = Vector2(1, 0);
	m->textureCoords[6] = Vector2(0, 1);
	m->textureCoords[7] = Vector2(1, 1);
	m->textureCoords[8] = Vector2(1, 0);
	m->textureCoords[9] = Vector2(1, 1);
	m->textureCoords[10] = Vector2(0, 1);
	...
	for (int i = 0; i < m->numVertices; i++) {
		m->colours[i] = Vector4(0.0, 0.0, 0.0, 1.0);
	}
	m->BufferData();
	return m;
}
